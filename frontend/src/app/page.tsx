      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-500">No products found. Debug info:</p>
            <p className="text-sm text-gray-400">Loading: {loading.toString()}</p>
            <p className="text-sm text-gray-400">Products count: {featuredProducts.length}</p>
          </div>
        )}
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><Link href="/electronics" className="hover:text-white">Electronics</Link></li>
                <li><Link href="/clothing" className="hover:text-white">Clothing</Link></li>
                <li><Link href="/home" className="hover:text-white">Home & Garden</Link></li>
