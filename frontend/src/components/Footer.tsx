        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><Link href="/beauty" className="hover:text-white transition-colors">Beauty & Health</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form className="space-y-3">
              <input
                ...
                className="w-full px-4 py-2 rounded-lg text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none"
              />
